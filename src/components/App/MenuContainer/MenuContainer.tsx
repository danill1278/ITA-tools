...
import { removeSubmenu } from "../../../store/actions";
...
const MenuContainer = ({ ...props }: any) => {
  ...
  return (
    <MainMenu>
      ...
      />
      <Chat />
      {props.section2.menu[0] && (
        <NavigationMenu
          menu={props.section2.menu}
          activeId={props.activeId}
      ...
      {props.section3.menu[0] && (
        <NavigationMenu
          menu={props.section3.menu}
          activeId={props.activeId}
          activeColor={props.activeColor}
...
const mapDispatchToProps = (dispatch: any) => ({
  removeSubmenu: () => dispatch(removeSubmenu()),
  dispatch
});
