...
const MenuItems = ( props : any) => {
    ...
    padding: 5px;
    background-color: ${(((props.section1.activeId === props.menuItem.id) && props.section1.activeBGColor)
        || ((props.section2.activeId === props.menuItem.id) && props.section2.activeBGColor) ||
        ((props.section3.activeId === props.menuItem.id) && props.section3.activeBGColor))};
    color: ${(((props.section1.activeId === props.menuItem.id) && props.section1.activeColor)
        || ((props.section2.activeId === props.menuItem.id) && props.section2.activeColor) ||
        ((props.section3.activeId === props.menuItem.id) && props.section3.activeColor))};
`;
    return (
